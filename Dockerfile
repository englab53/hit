...
CMD /nh.sh --token=$TOKEN --system-session --ex-proxy-sessions=3 --allow-crypto=no --session-note=9hits-pool --note=HF-Space --hide-browser & python3 -m http.server 7860
